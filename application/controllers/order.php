...
//    }
     ...
     function _showHeader(){
         ...
         $data['css'] = array("css/reset.css","css/jquery-ui-1.8.23.custom.css","css/bootstrap.css","css/photo.css",
                              "assets/css/fileupload/bootstrap-image-gallery.min.css","assets/css/fileupload/jquery.fileupload-ui.css",
                              "assets/css/fileupload/jquery.fileupload-ui.css");
         
         $data['js'] = array("js/jquery.min.js", "js/jquery-ui.min.js","js/bootstrap.js","assets/js/fileupload/vendor/jquery.ui.widget.js",
                             "assets/js/fileupload/tmpl.js","assets/js/fileupload/load-image.js","assets/js/fileupload/canvas-to-blob.js",
                             "assets/js/fileupload/bootstrap-image-gallery.min.js","assets/js/fileupload/jquery.iframe-transport.js",
                             "assets/js/fileupload/jquery.fileupload.js","assets/js/fileupload/jquery.fileupload-ip.js",
                             "assets/js/fileupload/jquery.fileupload-ui.js","assets/js/fileupload/locale.js","assets/js/fileupload/main.js","js/send.js","js/photo.js");
         
         $data['description'] = "Рисую картины на заказ, форма заказа";
         
         $data['keywords'] = "картины, заказ, рисовать, маслом, форма, заказа";
